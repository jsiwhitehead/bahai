...
export const files = {
  ...
  bahaullah: {
    ...
    "additional-tablets-extracts-from-tablets-revealed-bahaullah": [
      ...
      prefix(/^O “Times”, O thou endowed with the power/m, "#\n\n"),
      prefix(/^All should know, and in this regard/m, "#\n\n"),
      prefix(/^This Ḥuqúq which hath been mentioned/m, "#\n\n"),
      prefix(/^If the learned ones of the earth were/m, "#\n\n"),
      prefix(/^In this Day the Bayán is conditioned/m, "#\n\n"),
      prefix(/^This, truly, is a Revelation which/m, "#\n\n"),
      ...
      prefix(/^The truth is manifest, the kingdom of utterance/m, "#\n\n"),
      prefix(/^His first inquiry concerneth the fact that, in/m, "#\n\n"),
      prefix(/^These, in brief, are the prerequisites/m, "#\n\n"),
      prefix(/^As to the children: We have directed that/m, "#\n\n"),
      prefix(/^O friends! You must all be so ablaze in this/m, "#\n\n"),
      prefix(/^Thou hast asked about affection and reconciliation/m, "#\n\n"),
      prefix(/^The state of affairs hath changed, the countries/m, "#\n\n"),
      prefix(/^We testify that thou didst enter the prison/m, "#\n\n"),
      prefix(/^What thou hadst written regarding martyrdom/m, "#\n\n"),
      prefix(/^O Zayn! It behoveth thee to entreat God/m, "#\n\n"),
      prefix(/^O Samandar! How many are the souls who/m, "#\n\n"),
      prefix(/^He it is Who shineth forth in splendour/m, "#\n\n"),
      prefix(/^Glory be to the Lord of the world, and thanks/m, "#\n\n"),
      prefix(/^The maidservant of God Khurshíd in the Land/m, "#\n\n"),
      prefix(/^As for thy mention of the Obligatory Prayer: In/m, "#\n\n"),
      prefix(/^In the early days, when the Divine verses were/m, "#\n\n"),
      prefix(/^By God! The Preserved Tablet hath appeared;/m, "#\n\n"),
      prefix(/^Concerning the question of language: In the/m, "#\n\n"),
      prefix(/^You asked about My sons\. \. \. \. And one of them/m, "#\n\n"),
      prefix(/^He is the True, the Faithful\./m, "#\n\n"),
      prefix(/^Jináb‑i‑Áqá Muḥammad Ṣádiq/m, "#\n\n"),
      prefix(/^Remember us to all those in thy land who have/m, "#\n\n"),
    ...
    "additional-prayers-revealed-bahaullah": [
      ...
      prefix(/^Glorified art Thou, O Lord my God! Behold/m, "#\n\n"),
      prefix(/^O Thou Who art the Lord of all names/m, "#\n\n"),
      prefix(/^He is God, exalted is He, the Lord of wisdom/m, "#\n\n"),
...
And finally We beseech God, exalted be His glory, to enable thee to aid His Faith and turn towards His justice, that thou mayest judge between the people even as thou wouldst judge between thine own kindred, and mayest choose for them that which thou choosest for thine own self. He, verily, is the All‑Powerful, the Most Exalted, the Help in Peril, the Self‑Subsisting.`,
    ...
    "additional-prayers-revealed-abdul-baha": [
      ...
      [/^—‘Abdu’l‑Bahá$/gm, "#"],
      prefix("He is God.\n\nO Thou kind Lord! Illumine", "\n\n#\n\n"),
      prefix("He is God.\n\nO Divine Providence! Bestow", "\n\n#\n\n"),
      prefix("He is God.\n\nO ye children of", "\n\n#\n\n"),
      prefix("He is God!\n\nPraise be unto Thee,", "\n\n#\n\n"),
      prefix("O Lord, my Lord! I praise Thee", "\n\n#\n\n"),
