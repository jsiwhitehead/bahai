...
And finally We beseech God, exalted be His glory, to enable thee to aid His Faith and turn towards His justice, that thou mayest judge between the people even as thou wouldst judge between thine own kindred, and mayest choose for them that which thou choosest for thine own self. He, verily, is the All‑Powerful, the Most Exalted, the Help in Peril, the Self‑Subsisting.`,
  ...
  "shoghi-effendi": {
    ...
    "bahai-administration": [
      ...
      ["the greatest benefits and", "the greatest benefit and"],
    ],
    "citadel-faith": [
    ...
    "world-order-bahaullah": [
      ...
      ["catch a lightening glimpse", "catch a lightning glimpse"],
    ],
  },
  "the-universal-house-of-justice": {
  ...
  compilations: {
    ...
    "national-spiritual-assembly": [
      ...
      title("", "The National Spiritual Assembly", {
        author: "Compilation",
        years: [2023.1001, 2023.1001],
      }),
      title("#", "A Pivotal Instrument of the Administrative Order"),
      title("#", "Facilitating an Evolving Framework for Action"),
      title("###", "Regional Bahá’í Councils"),
      title("###", "The Training Institute"),
      title("###", "Local Spiritual Assemblies"),
      title("###", "The Institution of the Fund"),
      title("#", "Releasing the Society‑Building Power of the Cause"),
      title("###", "Social Action"),
      title("###", "Involvement in the Discourses of Society"),
      title("#", "The Three Protagonists"),
      [/^[A-Z].{0,80}[a-z]$/gm, (a) => `## ${a}`],
      ["## The National Spiritual Assembly", "The National Spiritual Assembly"],
      ["and insignificant member of", "and insignificant members of"],
      ["grasp and practice it properly", "grasp and practise it properly"],
      ["provided that they have", "provided they have"],
      ["but also can confidently", "but who also can confidently"],
      ["God has “endowed each", "God “hast endowed each"],
    ],
    peace: [
      removeAfter("Notes"),
      ["August 1985", ""],
